<template>
  <main class="w-full lg:flex lg:space-x-5 lg:divide-x-2 divide-gray-D9">
    ...
    <section class="lg:w-1/2 lg:pr-7">
      ...
      <div class="mt-1">
        <div class="rounded-[26px] border border-grayD9 py-3 px-4 pb-16">
          <p class="text-center font-bold">Módulos esenciales</p>
          ...
          <ul class="mt-5 *:text-[#b86ce7] space-y-3 text-sm">
            <li>
              ...
              <p class="text-gray-600">Registra ventas y genera tickets de manera rápida y sencilla.</p>
            </li>
            <li>
              <div class="flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="-0.855 -0.855 24 24" height="17" width="19"
              ...
              <p class="text-gray-600">Consulta y analiza las ventas, gastos y desempeño del negocio.</p>
            </li>
            <li>
              <div class="flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="-0.855 -0.855 24 24" height="17" width="19"
              ...
              <p class="text-gray-600">Organiza cada transacción para un mejor control y seguimiento.</p>
            </li>
            <li>
              <div class="flex items-center space-x-2">
              ...
              <p class="text-gray-600">Controla ingresos, ventas y retiros al instante</p>
            </li>
            <li>
              <div class="flex items-center space-x-2">
              ...
              <p class="text-gray-600">Administra tu catálogo, incluyendo precios, detalles y stock disponible.</p>
            </li>
            <li>
              <div class="flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              ...
              <p class="text-gray-600">Personaliza las opciones del sistema según las necesidades de tu negocio.</p>
            </li>
          </ul>
        </div>

        <p class="mx-7 my-3 text-center">Los siguientes módulos son opcionales. Seleccionalos según tus
          necesidades </p>
        ...
        <div class="mt-4 px-3">
          ...
          <div class="flex border-b border-grayD9 pb-2">
            ...
            <p class="w-1/2 text-right"><span class="mr-1">$</span><span class="w-20 inline-block">{{ period ===
              'Mensual' 
              ? baseModulesCost.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",") 
              : (baseModulesCost * 10).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}</span></p>
          </div>
...
export default {
    ...
    return {
      ...
      modules: [
        ...
        },
        {
          ...
          description: 'Administra tus ordenes de servicio de manera eficiente.',
          cost: 30,
          activated: false,
        },
      ]
  ...
  methods: {
    checkout() {
      ...
      this.form.activeModules.unshift({ name: "Módulos básicos", cost: this.baseModulesCost }); //se agregan los modulos escenciales o basicos para mostrarlo en detalles de pago
  ...
  computed: {
    calculateTotal() {
      return this.modules
        ...
        .reduce((sum, item) => sum + item.cost, 0) + this.baseModulesCost;
    }
  },
  mounted() {
