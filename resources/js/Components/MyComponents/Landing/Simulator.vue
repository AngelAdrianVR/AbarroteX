<template>
  <main class="w-full flex space-x-5 divide-x-2 divide-[#373737]">
    ...
    <section class="w-1/2 lg:pr-7">
      ...
      <div class="mt-1">
        <el-select class="w-1/2 !rounded-full h-10 !bg-transparent" v-model="storeType" filterable clearable
        ...
        <p class="my-9 text-white mx-7 text-center">Los siguientes módulos son opcionales. Los que están activados son
          los recomendados para el giro que seleccionaste.</p>
