    ...
    <article class="border border-grayD9 rounded-md text-xs lg:text-base">
        <header
            ...
            <div class="flex items-center space-x-1 lg:space-x-3">
                <p v-if="groupedSales.quote_folio" class="text-gray99">
                    Cotización:
                    <a as="button" :href="route('quotes.show', encodeId(groupedSales.products[0].quote_id))"
                        ...
                        C-{{ String(groupedSales.quote_folio).padStart(4, '0') }}
                    </a>
                </p>
                <span v-if="groupedSales.quote_folio" class="text-gray99">•</span>
