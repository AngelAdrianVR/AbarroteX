<template>
    <div class="overflow-auto">
        <div v-if="selectedReports.length" class="mb-4">
            <el-button type="danger" @click="deleteSelected">Eliminar ({{ selectedReports.length }})</el-button>
        </div>
        <table v-if="reports?.length" class="w-full table-fixed">
            ...
            <tbody>
                <tr @click="openTemplate(report.id)"
                    ...
                    <td class="flex items-center mt-[5px] space-x-2">
                        ...
                        <el-dropdown trigger="click" @command="handleCommand">
                            ...
                            <template #dropdown>
                                <el-dropdown-menu>
                                    ...
                                    <el-dropdown-item v-if="canDelete" :command="'changeStatus|' + report.id + '|Recibida'">
                                    ...
                                    <el-dropdown-item v-if="canDelete" :command="'changeStatus|' + report.id + '|En proceso'">
                                    ...
                                    <el-dropdown-item v-if="canDelete" :command="'changeStatus|' + report.id + '|Listo para entregar'">
                                    ...
                                    <el-dropdown-item v-if="canDelete" :command="'changeStatus|' + report.id + '|Entregado/Pagado'">
                                    ...
                                    <el-dropdown-item v-if="canDelete" :command="'changeStatus|' + report.id + '|Cancelada'">
                                        <svg class="size-[14px] mr-2" width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
