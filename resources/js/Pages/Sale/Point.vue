            ...
            <div class="border border-grayD9 rounded-lg p-4 mt-5 text-xs lg:text-base">
              <div class="relative" v-if="productFoundSelected">
                ...
                <div class="flex justify-between items-center mt-4">
                  ...
                  <el-input-number ref="quantitySelector" @keydown.enter="focusAddButton()" v-if="isInventoryOn"
                    v-model="quantity" :min="0" :max="productFoundSelected.current_stock" :precision="2"
                    :disabled="isReading" />
                  <el-input-number ref="quantitySelector" @keydown.enter="focusAddButton()" v-else v-model="quantity"
                    :min="0" :precision="2" :disabled="isReading" />
                </div>
                <div class="text-center mt-7">
                  ...
                  <div class="flex items-center justify-center space-x-3">
                    ...
                    <el-tooltip content="Pesar con báscula" placement="bottom">
                      <button @click="handleScale()"
                        v-if="productFoundSelected?.bulk_product && $page.props.auth.user.scale_config.is_enabled"
                        :disabled="isReading"
                    ...
                    <el-tooltip content="Terminar lectura" placement="bottom">
