                            ...
                            <div v-if="form.suscription_period" class="col-span-full md:pl-5 pt-7 pb-3 rounded-lg">
                                <div class="flex justify-between items-center relative">
                                    ...
                                    <el-tooltip class="" content="Contactar con soporte" placement="left">
                                        <a href="https://api.whatsapp.com/send?phone=523321705650" target="_blank" class="absolute top-0 right-0 flex items-center justify-center rounded-full size-7 bg-primary text-white">
                                ...
                                <article class="md:flex items-center justify-between rounded-[5px] px-4 pt-1 mt-3">
                                    <section>
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <span>${{ basicModulesCost.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}/ mes
                                            </span>
                                        </div>
...
export default {
    ...
    computed: {
        getSuscriptionAmount() {
            ...
            let totalCost = this.basicModulesCost;
    ...
    methods: {
        checkout() {
            ...
            this.form.activeModules.unshift({ name: "Módulos básicos", cost: this.basicModulesCost });
