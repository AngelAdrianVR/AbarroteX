<template>
    <section class="grid grid-cols-4 lg:grid-cols-6 gap-x-3 gap-y-2">
        <span class="text-gray37">Folio:</span>
        <span class="col-span-3 lg:col-span-5">{{ 'R-' + rent.id }}</span>
        <span class="text-gray37">Cliente:</span>
        <span class="col-span-3 lg:col-span-5">{{ rent.client.name }}</span>
        ...
        <p class="col-span-3 lg:col-span-5 relative">
