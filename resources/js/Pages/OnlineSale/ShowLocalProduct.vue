            ...
            <section class="xl:w-[60%] md:grid grid-cols-2 gap-x-10 mx-auto mt-9">
                ...
                <div>
                    ...
                    <el-input-number v-if="store?.online_store_properties?.inventory"
                        v-model="quantity" :disabled="product.current_stock < 1" :min="0" :max="product.current_stock" controls-position="right">
                    ...
                    <el-input-number v-else
                        v-model="quantity" :min="0" :max="999" controls-position="right">
                        <template #decrease-icon>
                        <i class="fa-solid fa-angle-down"></i>
                        </template>
                        <template #increase-icon>
                    ...
                    <p v-if="store?.online_store_properties?.inventory" class="mt-2 text-sm">Unidades disponibles: <span> {{ product.current_stock }} </span></p>
                    <!-- Boton -->
