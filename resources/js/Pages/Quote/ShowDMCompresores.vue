<template>
    ...
    <main :class="printing ? 'w-full' : 'w-[900px]'" class="mx-auto h-screen overflow-hidden p-2 md:px-7 md:py-4">
        ...
        <div class="*:px-4">
            ...
            <div class="font-bold bg-[#EDEDED] text-[#8C8489] flex">
                <p class="flex w-[65%]">
                    <span class="text-black">Tiempos de entrega: INMEDIATO</span> 
                </p>
                <p class="flex space-x-10 w-[35%]">
            ...
            <div class="font-bold flex">
                <p class="flex w-[65%]">
                    <span class="text-black">Nota: {{ quote.notes }}</span> 
                </p>
