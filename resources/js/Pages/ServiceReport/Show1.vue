<template>
    <Head :title="'Orden-' + String(report.folio).padStart(4, '0')" />
    <main :class="printing ? 'w-full' : 'w-[900px] mx-auto'" class="py-1 px-4 formato">
        ...
        <div v-for="(i, index) in 2" :key="i">
            <div class="flex justify-between items-center">
                <figure>
                    <img class="w-[57%]" src="@/../../public/images/apontephone.png" alt="">
                </figure>
            ...
            <body :class="index === 0 ? 'border-b border-gray-500 pb-2' : ''">
                <section class="grid grid-cols-2 gap-x-2 text-[#373737] text-sm rounded-2xl border border-[#D9D9D9] py-2 px-4">
                    <div class="flex items-center space-x-2">
                        <p class="w-[140px]">Fecha de recepción:</p>
                        <span class="font-semibold">{{ formatDate(report.created_at) }}</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <p class="w-24">Marca:</p>
                ...
                <section class="grid grid-cols-3 gap-x-1 text-sm">
                    ...
                    <article class="mt-2">
                        <div class="flex space-x-2">
                            ...
                            <DrawPatternMobil v-if="report.aditionals?.unlockPattern?.length" :points="report.aditionals.unlockPattern" />
