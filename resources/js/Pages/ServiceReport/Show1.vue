        ...
        <main class="py-4 px-1 lg:px-8">
                    ...
                    <el-dropdown-menu>
                        <el-dropdown-item @click="printTemplate" :disabled="report.status === 'Cancelada'">
                            <svg class="mr-1" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M11.375 8.3125V6.78125C11.375 6.2591 11.1676 5.75835 10.7984 5.38913C10.4292 5.01992 9.92839 4.8125 9.40625 4.8125H8.53125C8.3572 4.8125 8.19028 4.74336 8.06721 4.62029C7.94414 4.49722 7.875 4.3303 7.875 4.15625V3.28125C7.875 2.7591 7.66758 2.25835 7.29837 1.88913C6.92915 1.51992 6.42839 1.3125 5.90625 1.3125H4.8125M4.8125 8.75H9.1875M4.8125 10.5H7M6.125 1.3125H3.28125C2.919 1.3125 2.625 1.6065 2.625 1.96875V12.0312C2.625 12.3935 2.919 12.6875 3.28125 12.6875H10.7187C11.081 12.6875 11.375 12.3935 11.375 12.0312V6.5625C11.375 5.17011 10.8219 3.83476 9.83731 2.85019C8.85274 1.86562 7.51739 1.3125 6.125 1.3125Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            Comprobante de servicio</el-dropdown-item>
                        <el-dropdown-item :disabled="report.status === 'Cancelada'">
                            <svg class="mr-1" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3.92 8.06692C3.78 8.08442 3.64 8.10308 3.5 8.12292M3.92 8.06692C5.96532 7.81031 8.03468 7.81031 10.08 8.06692M3.92 8.06692L3.69833 10.5M10.08 8.06692C10.22 8.08442 10.36 8.10308 10.5 8.12292M10.08 8.06692L10.3017 10.5L10.4352 11.9718C10.4435 12.0626 10.4328 12.1541 10.4037 12.2405C10.3746 12.3269 10.3279 12.4063 10.2664 12.4737C10.2049 12.541 10.1301 12.5948 10.0467 12.6316C9.96327 12.6684 9.87309 12.6875 9.78192 12.6875H4.21808C3.83192 12.6875 3.52975 12.3562 3.56475 11.9718L3.69833 10.5M3.69833 10.5H3.0625C2.7144 10.5 2.38056 10.3617 2.13442 10.1156C1.88828 9.86944 1.75 9.5356 1.75 9.1875V5.516C1.75 4.88542 2.198 4.34058 2.82158 4.24725C3.19255 4.19176 3.5646 4.14372 3.9375 4.10317M10.3005 10.5H10.9369C11.1093 10.5001 11.2801 10.4662 11.4394 10.4003C11.5987 10.3343 11.7434 10.2377 11.8654 10.1158C11.9873 9.9939 12.084 9.84918 12.15 9.68991C12.216 9.53063 12.25 9.35991 12.25 9.1875V5.516C12.25 4.88542 11.802 4.34058 11.1784 4.24725C10.8074 4.19176 10.4354 4.14372 10.0625 4.10317M10.0625 4.10317C8.02684 3.88168 5.97316 3.88168 3.9375 4.10317M10.0625 4.10317V1.96875C10.0625 1.6065 9.7685 1.3125 9.40625 1.3125H4.59375C4.2315 1.3125 3.9375 1.6065 3.9375 1.96875V4.10317M10.5 6.125H10.5047V6.12967H10.5V6.125ZM8.75 6.125H8.75467V6.12967H8.75V6.125Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            Imprimir ticket
                        </el-dropdown-item>
                        <el-dropdown-item :disabled="report.status === 'Cancelada'">
                            <svg class="mr-1" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2.1875 2.84375C2.1875 2.4815 2.4815 2.1875 2.84375 2.1875H5.46875C5.831 2.1875 6.125 2.4815 6.125 2.84375V5.46875C6.125 5.831 5.831 6.125 5.46875 6.125H2.84375C2.6697 6.125 2.50278 6.05586 2.37971 5.93279C2.25664 5.80972 2.1875 5.6428 2.1875 5.46875V2.84375ZM2.1875 8.53125C2.1875 8.169 2.4815 7.875 2.84375 7.875H5.46875C5.831 7.875 6.125 8.169 6.125 8.53125V11.1562C6.125 11.5185 5.831 11.8125 5.46875 11.8125H2.84375C2.6697 11.8125 2.50278 11.7434 2.37971 11.6203C2.25664 11.4972 2.1875 11.3303 2.1875 11.1562V8.53125ZM7.875 2.84375C7.875 2.4815 8.169 2.1875 8.53125 2.1875H11.1562C11.5185 2.1875 11.8125 2.4815 11.8125 2.84375V5.46875C11.8125 5.831 11.5185 6.125 11.1562 6.125H8.53125C8.3572 6.125 8.19028 6.05586 8.06721 5.93279C7.94414 5.80972 7.875 5.6428 7.875 5.46875V2.84375Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M3.9375 3.9375H4.375V4.375H3.9375V3.9375ZM3.9375 9.625H4.375V10.0625H3.9375V9.625ZM9.625 3.9375H10.0625V4.375H9.625V3.9375ZM7.875 7.875H8.3125V8.3125H7.875V7.875ZM7.875 11.375H8.3125V11.8125H7.875V11.375ZM11.375 7.875H11.8125V8.3125H11.375V7.875ZM11.375 11.375H11.8125V11.8125H11.375V11.375ZM9.625 9.625H10.0625V10.0625H9.625V9.625Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            Generar etiqueta
                        </el-dropdown-item>
                        <el-dropdown-item @click="confirmDeleteModal = true">
                            <svg class="mr-1" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.59833 5.2503L8.3965 10.5003M5.6035 10.5003L5.40167 5.2503M11.2163 3.3778C11.4158 3.40814 11.6142 3.44022 11.8125 3.47464M11.2163 3.3778L10.5933 11.4762C10.5679 11.8059 10.419 12.1139 10.1763 12.3385C9.93357 12.5632 9.61503 12.6879 9.28433 12.6878H4.71567C4.38497 12.6879 4.06643 12.5632 3.82374 12.3385C3.58105 12.1139 3.43209 11.8059 3.40667 11.4762L2.78367 3.3778M11.2163 3.3778C10.5431 3.27602 9.86636 3.19878 9.1875 3.14622M2.78367 3.3778C2.58417 3.40755 2.38583 3.43964 2.1875 3.47405M2.78367 3.3778C3.45691 3.27602 4.13364 3.19878 4.8125 3.14622M9.1875 3.14622V2.61189C9.1875 1.92355 8.65667 1.34955 7.96833 1.32797C7.32294 1.30734 6.67706 1.30734 6.03167 1.32797C5.34333 1.34955 4.8125 1.92414 4.8125 2.61189V3.14622M9.1875 3.14622C7.73134 3.03368 6.26866 3.03368 4.8125 3.14622" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            Eliminar orden
                        </el-dropdown-item>
                    </el-dropdown-menu>
            ...
            <body class="lg:grid grid-cols-4 gap-4">
                <section class="col-span-3">
                    <StatusStep v-if="report.status !== 'Cancelada'" :activeStep="statuses.findIndex(status => status === report.status) + 1" :steps="statuses">
                        <template #icon-0>
                            <svg class="size-[19px] mr-2" width="17" height="13" viewBox="0 0 17 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M5.99232 8.28937C6.49168 11.3688 10.4533 11.5186 11.219 8.28937H16.5766L13.72 6.63869C13.5993 6.56894 13.4785 6.51799 13.4328 6.51799H12.0013C11.8692 6.51799 11.8692 6.39728 12.0013 6.39181H13.4328C13.5826 6.39181 13.7324 6.49117 13.8489 6.55826C15.136 7.2993 15.5913 7.54833 16.8784 8.28937V11.6517C16.8784 12.1511 16.6453 13 15.9629 13H1.38156C0.516005 13 0 12.3841 0 12.0845V8.28937L3.44558 6.44174C3.50845 6.40803 3.66134 6.39181 3.82228 6.39181C4.20512 6.39181 4.92702 6.37516 5.3598 6.39181C5.47189 6.39728 5.4773 6.51799 5.3598 6.51799H3.82228C3.70157 6.51799 3.6211 6.51547 3.54063 6.55822L0.281641 8.28937H5.99232Z" fill="#373737"/>
                                <path d="M8.03969 5.01024V0H9.18822V5.01024H10.8028L8.50576 7.27401L6.242 5.01024H8.03969Z" fill="#373737"/>
                            </svg>
                        </template>
                        <template #label-0>Recibida</template>

                        <template #icon-1>
                            <svg class="size-[19px] mr-2" width="13" height="16" viewBox="0 0 13 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7.57423 8.04782L6.69533 8.83421L4.42867 6.66007C2.16201 10.4995 6.16502 13.5988 8.83423 11.1471C9.64555 10.4019 10.3652 8.83421 9.23953 6.66007L10.7171 5.31857C11.6085 6.27663 12.1538 7.56113 12.1538 8.97298C12.1538 11.9365 9.75138 14.3389 6.78784 14.3389C3.8243 14.3389 1.42188 11.9365 1.42188 8.97298C1.42188 6.00944 3.8243 3.60702 6.78784 3.60702V1.52539M6.78784 1.52539H4.42867M6.78784 1.52539H8.83423" stroke="#373737" stroke-width="1.38775" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </template>
                        <template #label-1>En proceso</template>

                        <template #icon-2>
                            <svg class="size-[14px] mr-2" width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.05078 0C7.55666 0 8.93423 0.549765 9.99316 1.45996C10.9763 0.695148 11.5787 0.424377 12.6973 0.0917969C12.8806 0.0372847 13.0214 0.0457867 13.2021 0.0917969C13.2938 0.137854 13.4287 0.335015 13.5225 0.503906C13.5988 0.641428 13.6068 0.807884 13.5225 0.871094C12.573 1.58285 12.0774 2.0335 11.21 2.8877C11.7754 3.80807 12.1016 4.89139 12.1016 6.05078C12.1015 9.39261 9.39262 12.1016 6.05078 12.1016C2.70898 12.1015 2.75663e-05 9.39258 0 6.05078C0 2.70895 2.70896 4.42574e-05 6.05078 0ZM12.9268 0.273438C9.06853 1.70435 7.93919 3.53397 5.50098 6.50781C4.89269 5.61383 3.84319 4.7846 3.62207 4.6748C3.34619 4.53804 2.9344 4.5602 2.79688 4.6748L1.97168 5.3623C1.88146 5.44078 3.95789 7.5615 5.73047 9.0293C5.82127 9.10449 6.31822 9.12083 6.37207 9.0293C8.72076 4.99999 10.7269 2.52085 13.2939 0.640625C13.3617 0.594925 13.0184 0.239662 12.9268 0.273438Z" fill="#373737"/>
                            </svg>
                        </template>
                    ...
                    <div class="flex justify-between my-2 ml-4">
                        <button v-if="report.status !== 'Entregado/Pagado' && report.status !== 'Cancelada'" @click="confirmCancelModal = true" class="flex items-center hover:underline text-red-600 text-xs md:text-base">
                            <svg class="size-[14px] mr-2" width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="mt-5 ml-4 text-[15px]">
                        ...
                        <div v-if="report.status === 'Cancelada'" class="flex space-x-4 border-b border-[#D9D9D9] py-2 px-1">
                        ...
                        <div class="flex space-x-4 py-2 px-1">
                            ...
                            <p class="lg:w-1/2">{{ report.comision_percentage ?? '-' }}% => ${{ ((report.comision_percentage / 100) * report.service_cost)?.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}</p>
                        </div>
                        ...
                        <div class="pb-2 border-b border-[#D9D9D9]">
                            ...
                            <div v-for="part in report.spare_parts" :key="part" class="flex justify-between mt-3">
                                <div>
                                    ...
                                    <p class="text-[#999999] text-[14px]">$ {{ parseFloat(part.unitPrice).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}</p>
                                    <p class="text-[#999999] text-[14px]">Cantidad: {{ part.quantity }}</p>
                                </div>
                                <p><span class="mr-3">$</span> {{ (parseFloat(part.unitPrice) * parseFloat(part.quantity))?.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}</p>
                            </div>
                        </div>
                        ...
                        <div class="mt-2 text-[15px] space-y-1 flex flex-col items-end">
                            ...
                            <div v-if="report.status === 'Cancelada'">
                                ...
                                <p class="flex">
                                    <span class="w-40">Costo de Revisión</span><span class="ml-3">$</span><span class="w-24 text-right">{{ parseFloat(report.aditionals.review_amount)?.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",") ?? '0.00' }}</span>
                                </p>
                                <p class="flex">
                                    <span class="w-40">Anticipo</span><span class="ml-[2px]">- $</span><span class="w-24 text-right">{{ report.advance_payment?.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",") ?? '0.00' }}</span>
                                </p>
                                ...
                                <p v-else class="flex">
                                    <span class="w-40">Total pagado</span><span class="ml-3">$</span><span class="w-24 text-right">{{ parseFloat(report.aditionals.review_amount)?.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",") }}</span>
                                </p>
                            </div>
                        </div>
                        <div v-if="report.media.length" class="my-7">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 space-x-2">
                                <figure @click="openImage(media?.original_url)" class="border rounded-xl border-[#D9D9D9] overflow-hidden group" v-for="media in report.media" :key="media">
                                    <img class="w-full h-full object-cover transform transition-transform duration-500 group-hover:scale-110 cursor-zoom-in" :src="media?.original_url" alt="">
                                </figure>
                            </div>
                        </div>
                    </div>
