    ...
    <main :class="printing ? 'w-full' : 'w-[900px] mx-auto'" class="py-1 px-4 formato">
        ...
        <div v-for="(i, index) in 1" :key="i">
            ...
            <body :class="index === 0 ? 'border-dashed border-b border-gray-500 pb-2' : ''">
                <section
                    class="grid grid-cols-2 gap-x-2 text-[#373737] text-[12px] rounded-2xl border border-[#D9D9D9] py-2 px-4">
                ...
                <div class="col-span-full mx-auto mt-2">
                    ...
                    <p class="text-[12px]">1. Si su equipo no prende, no se responde por otros daños del celular debido
                        a que no se pudo revisar. <br>
                        ...
                        4. No se responde garantía por daños ocasionados por alto voltaje, humedad, golpe o mal manejo
                        del equipo. <br>
                        5. Garantía solo por hardware excepto display y táctil, tampoco por software ni
                        desconfinguración. <br>
                        6. Departamento técnico no se hace responsable por pérdida de información, el cliente debe de
                        tener backup. <br>
