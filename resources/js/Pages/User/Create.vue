...
export default {
    ...
    computed: {
        usersNotExceededYet() {
            ...
            if (hasMoreUsers && this.total_users <= 10) {
                return true;
            } else if (!hasMoreUsers && this.total_users <= 5) {
                return true;
            } else {
                return false;
            }
