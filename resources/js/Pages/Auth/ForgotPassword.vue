...
<template>
    ...
    <AuthenticationCard>
        ...
        <h1 class="text-center text-grayD9 text-xl">¿Olvidaste tu contraseña?</h1>

        <div class="my-4 mx-5 text-sm text-grayD9">
            ...
            <div>
                <div
                    ...
                    <input v-model="form.email" id="email"
                        class="text-sm text-grayD9 w-full placeholder:text-sm placeholder:text-gray-400 border-0 focus:ring-0 focus:border-grayD9 border-grayD9 border-l h-full bg-transparent"
