...
<template>
    ...
    <AuthenticationCard>
        ...
        <div class="flex items-center justify-around mt-2 mb-8 mx-11 border-b border-gray-600 text-sm">
            <button @click="$inertia.visit(route('login'))" type="button" class="text-[#D9D9D9] px-2">Iniciar
                sesión</button>
            <span class="text-primary px-2 border-b-2 border-primary">Registrarse</span>
        </div>

        <form @submit.prevent="submit">
            <h1 class="text-[#D9D9D9] font-bold ml-9 text-sm mb-2">Información de la tienda</h1>
            <div>
                <!-- <div
                    class="flex items-center space-x-2 py-2 mt-3 px-5 w-full h-10 border border-grayD9 rounded-full placeholder:text-sm placeholder:text-[#D9D9D9]">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 !text-[#D9D9D9]">
            ...
            <div class="mt-3">
                <div
                    class="flex items-center space-x-2 py-2 px-5 w-full h-10 border border-grayD9 rounded-full placeholder:text-sm placeholder:text-[#D9D9D9]">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-5 text-[#D9D9D9]">
            ...
            <h1 class="text-[#D9D9D9] font-bold ml-9 text-sm mt-3">Contacto</h1>

            <div>
                <div
                    class="flex items-center space-x-2 py-2 px-5 mt-3 w-full h-10 border border-grayD9 rounded-full placeholder:text-sm placeholder:text-[#D9D9D9]">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-5 text-[#D9D9D9]">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="mt-3">
                <p class="text-[#D9D9D9] text-[10px] text-center">* Debe ser un correo válido porque lo necesitas para activar tu
                    cuenta *</p>
                <div
                    class="flex items-center space-x-2 py-2 px-5 w-full h-10 border border-grayD9 rounded-full placeholder:text-sm placeholder:text-[#D9D9D9]">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-4 text-[#D9D9D9]">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div>
                <div
                    class="mt-3 flex items-center space-x-2 py-2 px-5 w-full h-10 border border-grayD9 rounded-full placeholder:text-sm placeholder:text-[#D9D9D9]">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-4 text-[#D9D9D9]">
                        <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <button @click="showPassword = !showPassword" type="button" class="z-10">
                        <svg v-if="!showPassword" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor" class="size-4 text-[#D9D9D9]">
                            <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="mt-6 mx-9 flex items-center space-x-2 text-sm">
                <p class="text-[#D9D9D9]">¿Ya tienes cuenta?</p>
            ...
            <!-- <div class="flex items-center justify-center mt-4">
                <button
                    class="w-full border border-grayD9 rounded-full flex items-center justify-center space-x-3 py-1 text-sm text-[#D9D9D9] disabled:opacity-25 disabled:cursor-not-allowed"
