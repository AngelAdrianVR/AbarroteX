    ...
    <AuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div>
                ...
                <div class="mt-3">
                    <el-select class="w-1/2 !rounded-full h-10" v-model="form.type" filterable clearable
            ...
            <div class="mt-3">
                <p class="text-[10px] text-center">* Debe ser un correo válido porque lo necesitas para activar tu
                    cuenta *</p>
                <div
                    class="flex items-center space-x-2 py-2 px-5 w-full h-10 border border-grayD9 rounded-full placeholder:text-sm placeholder:text-[#777777]">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
