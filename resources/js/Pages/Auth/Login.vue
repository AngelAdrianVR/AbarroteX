...
<template>
    ...
    <AuthenticationCard>
        ...
        <div class="flex items-center justify-around mt-5 mb-8 mx-11 border-b text-sm">
            ...
            <button @click="$inertia.visit(route('register'))" type="button" class="text-[#777777] px-2">Registrarse</button>
        </div>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex items-center justify-center mt-6 px-9">
            ...
            <div class="mt-6 mx-9 flex items-center space-x-2 text-sm">
                <p class="text-[#777777]">¿No tienes cuenta?</p>
            ...
            <div class="flex items-center justify-center mt-4">
                <button class="w-full border border-grayD9 rounded-full flex items-center justify-center space-x-3 py-1 text-sm text-[#777777] disabled:opacity-25 disabled:cursor-not-allowed"
