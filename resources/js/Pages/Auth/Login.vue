    ...
    <AuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="block mt-4 ml-6">
                <el-checkbox class="!text-[#D9D9D9]" v-model="form.remember" name="remember" label="Mantener sesión abierta" size="small" />
            </div>

            <Link v-if="canResetPassword" :href="route('password.request')"
                class="block mt-6 underline text-sm text-center text-[#D9D9D9] focus:outline-none">
