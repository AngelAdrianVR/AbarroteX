                    ...
                    <footer class="flex justify-between items-center bg-[#232323] p-3 h-[72px] md:h-24 md:px-7">
                        ...
                        <div v-if="store?.online_store_properties?.whatsapp" class="hidden md:flex flex-col items-center">
                            ...
                            <div class="flex items-center space-x-3 mt-2">
                                ...
                                <p class="text-gray99 tracking-widest">{{ store?.online_store_properties?.whatsapp }}</p>
                            </div>
                        </div>
                        <!-- ubicación de tienda -->
                        ...
                        <a v-if="store?.online_store_properties?.whatsapp" class="z-50 size-12 rounded-full bg-green-500 shadow-md flex items-center justify-center fixed bottom-8 md:bottom-20 right-1 hover:scale-105"
                            :href="whatsappLink"
