                ...
                <nav class="bg-white border-b border-grayD9">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="flex justify-between h-12">
                            ...
                            <div class="hidden sm:flex sm:items-center sm:ms-6">
                                ...
                                <OnlineSalesNotifications v-if="$page.props.auth.user.store.activated_modules.includes('Tienda en línea')" />
                                <!-- notifications -->
                                <NotificationsCenter />
                            ...
                            <div class="-me-2 flex items-center sm:hidden">
                                <!-- notificaciones de tienda en linea -->
                                <OnlineSalesNotifications v-if="$page.props.auth.user.store.activated_modules.includes('Tienda en línea')" class="-mr-4" />
                                <!-- notifications -->
                                <NotificationsCenter />
                                <button
                    ...
                    <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }"
                        ...
                        <div class="pt-2 pb-3 space-y-px">
                            <ResponsiveNavLink v-if="$page.props.auth.user.store.activated_modules.includes('Punto de venta')" :href="route('sales.point')" :active="route().current('sales.point')">
                            ...
                            <ResponsiveNavLink v-if="$page.props.auth.user.store.activated_modules.includes('Reportes')" :href="route('dashboard')" :active="route().current('dashboard')">
                            ...
                            <ResponsiveNavLink v-if="$page.props.auth.user.store.activated_modules.includes('Ventas registradas')" :href="route('sales.index')"
                            ...
                            <ResponsiveNavLink v-if="$page.props.auth.user.store.activated_modules.includes('Gastos')" :href="route('expenses.index')" :active="route().current('expenses.*')">
                            ...
                            <ResponsiveNavLink v-if="$page.props.auth.user.store.activated_modules.includes('Productos')" :href="route('products.index')"
                            ...
                            <ResponsiveNavLink v-if="$page.props.auth.user.store.activated_modules.includes('Caja')" :href="route('cash-registers.index')"
                            ...
                            <ResponsiveNavLink v-if="$page.props.auth.user.store.activated_modules.includes('Configuraciones')" :href="route('settings.index')" :active="route().current('settings.*')">
