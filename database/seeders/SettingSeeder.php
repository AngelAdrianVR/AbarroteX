...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Setting::create(['key' => 'Selección rápida de productos sin código', 'type' => 'Bool', 'module' => 'Punto de venta', 'description' => 'Muestra en la vista principal una lista de productos para seleccionar y agregar a la venta sin necesidad de escanear el código de barras']);
        Setting::create(['key' => 'Impresión automática de tickets', 'type' => 'Bool', 'module' => 'Punto de venta', 'description' => 'Activa la impresión automática de tickets después de cada venta.<br>Nota: Es necesario haber configurado previamente una impresora. De lo contrario, esta función no estará disponible.<br>']);
    }
}
